...
def build_system_prompt():
    ...
    prompt = """Eres ORION, un asistente que interpreta instrucciones de lenguaje natural y las traduce en acciones programables.
...
"""
    ...
    for func_name, info in functions.items():
        prompt += f"\n- {func_name}: {info['description']}. Argumentos: {list(info['argument_types'].keys())}"
    ...
    prompt += '\nTú: {"CALL": "convert_csv_to_json", "ARGS": {"input_path": "data/ventas.csv", "output_path": "output/ventas.json"}}'
